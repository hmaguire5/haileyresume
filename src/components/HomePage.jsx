    ...
    document.getElementById("experience").scrollIntoView({ behavior: 'smooth' }); // Smoothly scroll to the experience section
        ...
        <section class="about" id="about">
                ...
                <div class="parent_rectangle_left">
                    ...
                    <p class="child_rectangle2_text">  My current position as an Aircraft Prep Specialist at NetJets/West Star Aviation has strengthened my leadership and communication skills, adaptability, ability to work under time constraints, and productivity. Often I lead, schedule, and assign staff to specific planes based on tight schedules
</p>
</div>
                    </div>
